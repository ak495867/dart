...
urlpatterns = [
    ...
    url(r'^(?P<pk>\d+)/clone/$',
        login_required(missions.views.CloneMissionView.as_view()), name='missions-clone',),
    ...
    url(r'^(?P<mission>\d+)/export/$',
        login_required(missions.views.ExportMissionView.as_view()), name='mission-export',),
